...
const env = {
    ...
    parseServer: {
        ...
        dashboardPassword: process.env.PARSE_SERVER_DASHBOARD_PASSWORD || '$2y$12$eo5ub5QnplinTqhcRC4Af.O30ho5mVUdFlG00Jax1vk3h9sdtVfqm', // Explorer01
        ...
        databaseURI: process.env.PARSE_SERVER_DATABASE_URI || 'mongodb://localhost:27018/dev',
